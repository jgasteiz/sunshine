...
public class TestProvider extends AndroidTestCase {
    ...
    public void insertKalamazooData() {
        ContentValues kalamazooLocationValues = TestDb.createKalamazooLocationValues();
        Uri locationInsertUri = mContext.getContentResolver()
        ...
        ContentValues kalamazooWeatherValues = TestDb.createKalamazooWeatherValues(locationRowId);
        Uri weatherInsertUri = mContext.getContentResolver()
    ...
    public void testUpdateAndReadWeather() {
        ...
        ContentValues kalamazooAltered = TestDb.createKalamazooWeatherValues(locationRowId);
